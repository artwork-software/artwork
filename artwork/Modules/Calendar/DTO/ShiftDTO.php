...
class ShiftDTO extends Data
{
    ...
    public static function fromModel(Shift $shift, ?Project $project = null): ShiftDTO
    {
        return new self(
            ...
            users: $shift->users->loadMissing('globalQualifications'),
            freelancer: $shift->freelancer->loadMissing('globalQualifications'),
            serviceProviders: $shift->serviceProvider->loadMissing('globalQualifications'),
            room: $shift->room,
