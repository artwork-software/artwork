...
class RestTimeBeforeWorkdayCheck extends AbstractRuleCheck
{
    public function check(ShiftRule $rule, User $user, Carbon $startDate, Carbon $endDate): Collection
    {
        ...
        foreach ($dateRange as $date) {
            ...
            if ($this->isWorkday($date)) {
                // Check rest time from previous day to first shift of current workday
                ...
                // Check rest time between multiple shifts on the same workday
