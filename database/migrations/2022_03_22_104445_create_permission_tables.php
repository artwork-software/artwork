...
return new class extends Migration
{
    ...
    public function up(): void
    {
        ...
        if ($teams && empty($columnNames['team_foreign_key'] ?? null)) {
            throw new \Exception(
                'Error: team_foreign_key on config/permission.php not loaded. Run " .
        ...
        Schema::create(
            ...
            function (Blueprint $table) use ($tableNames, $columnNames, $teams): void {
    ...
    public function down(): void
    {
        ...
        if (empty($tableNames)) {
            throw new \Exception(
                'Error: config/permission.php not found and defaults could not be merged. Please publish " .
                    "the package configuration before proceeding, or drop the tables manually.'
            );
        }
