...
return new class extends Migration {
    ...
    public function up(): void
    {
        ...
        Schema::table('component_department', static function (Blueprint $table) {
        ...
        Schema::table('components_in_tabs', static function (Blueprint $table) {
            $table->foreign('project_tab_id')
                ->references('id')
                ->on('project_tabs')
                ->cascadeOnUpdate();
            $table->foreign('component_id')
        ...
        Schema::table('component_user', static function (Blueprint $table) {
            $table->foreign('user_id')
                ->references('id')
                ->on('users')
                ->cascadeOnUpdate();
