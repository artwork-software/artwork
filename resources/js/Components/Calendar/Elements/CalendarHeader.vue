<template>
    <div class="flex items-center sticky  gap-0.5 h-16 bg-userBg z-30 rounded-t-xl divide-x divide-secondaryHover divide-dashed first-line:divide-none" :class="filteredEventsLength > 0 ? 'top-[72px]' : 'top-[72px]'">
