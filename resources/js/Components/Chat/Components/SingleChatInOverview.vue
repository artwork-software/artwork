    ...
    >
        ...
        <div class="shrink-0 relative">
            ...
            <PropertyIcon name="IconUsersGroup"
                v-else
                class="size-10 rounded-xl p-2.5 bg-accent-50 text-accent-700 border border-accent-200 ring-2 ring-white shadow-sm"
                aria-hidden="true"
            />
        </div>
        ...
        <div class="flex-1 min-w-0">
            ...
            <h4
                class="truncate"
                :class="isUnread ? 'text-[13px] font-semibold text-text' : 'text-[13px] font-medium text-text'"
            >
            ...
            <div class="mt-0.5 text-xs text-text-subtle">
                ...
                >
                    ...
                    <span
                        class="shrink-0"
                        :class="isUnread ? 'text-text-muted font-semibold' : 'text-text-muted'"
                    >
