            ...
            <div class="fixed inset-0 z-50 w-screen overflow-y-auto">
                <div class="flex min-h-full items-end justify-center p-4 text-center sm:items-center sm:p-0">
                    <TransitionChild as="template" enter="ease-out duration-300"
                        ...
                        <DialogPanel class="flex h-fit w-full grow flex-col rounded-3xl bg-gradient-to-br  text-left shadow-glass backdrop-blur-2xl p-gap-3xl border draggableModal" :class="[modalSize, showBackdrop ? 'border-gray-300 from-slate-50/80 to-sky-100/50' : 'border-gray-100 from-slate-50/70 to-sky-100/20']"  ref="containerRef">
                            ...
                            <div class="p-5">
                                <div class="shadow-[0_2px_5px_rgb(0,0,0,0.12)] p-4 bg-white rounded-3xl border border-gray-100 w-full relative">
                                    <slot/>
                                </div>
                            </div>
                        </DialogPanel>
