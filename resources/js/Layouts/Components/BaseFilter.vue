<template>
    <Menu as="div" class="relative flex items-center text-left">
        ...
        >
            <MenuItems v-if="left" class="w-80 absolute left-0 top-12 origin-top-left divide-y divide-gray-200 rounded-sm bg-primary ring-1 ring-black p-2 text-white opacity-100 z-50 max-h-[calc(100vh-10rem)] overflow-auto">
                <slot></slot>
            </MenuItems>
            <MenuItems v-else class="w-80 absolute right-0 top-12 origin-top-right divide-y divide-gray-200 rounded-sm bg-primary ring-1 ring-black p-2 text-white opacity-100 z-50 max-h-[calc(100vh-10rem)] overflow-auto">
                <slot></slot>
            </MenuItems>
        </transition>
    </Menu>
