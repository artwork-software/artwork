<template>
    ...
    <CalendarFilterTagComponent :calendar-filters="calendarFilters"/>
...
export default {
    ...
    methods: {
         ...
         */
        async fetchEvents({view, startDate, endDate, calendarFilters}) {
        ...
        addFilterableVariable(dataArray) {
            dataArray.forEach(element => element.checked = false);
        },
