        ...
        <div class="mx-4">
            ...
            <div v-if="canEdit">
                ...
                <div class="flex justify-center w-full py-4" v-else>
                    <FormButton
                        :disabled="!this.selectedRoom || this.selectedRoom === '' || !submit || endDate > seriesEndDate || series && !seriesEndDate || !this.$can('request room occupancy') && !isPlanning || !this.$can('can see planning calendar') && isPlanning"
