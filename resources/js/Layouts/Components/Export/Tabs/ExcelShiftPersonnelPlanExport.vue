        ...
        <div class="flex flex-col space-y-6">
            ...
            <section class="rounded-2xl border border-border-subtle bg-white px-4 py-3 shadow-sm">
                <div class="flex items-center gap-3">
                    <div class="grid size-10 place-items-center rounded-2xl bg-surface-inverse text-white shadow-sm">
                ...
                <div class="mt-3 space-y-2">
                    <button
                        ...
                        :class="numberFormat === 'readable'
                            ...
                            : 'border-border-subtle bg-white hover:bg-surface-sunken'"
                        @click="numberFormat = 'readable'"
                    >
                        <div class="flex items-center gap-3">
                            <span
                                class="grid size-4 shrink-0 place-items-center rounded-full border"
                                :class="numberFormat === 'readable' ? 'border-surface-inverse' : 'border-border'"
                            >
                                <span v-if="numberFormat === 'readable'" class="size-2 rounded-full bg-surface-inverse" />
                            </span>
                            <div class="min-w-0">
                                <div class="text-sm font-semibold text-text">
                                    {{ $t('Readable format') }}
                    ...
                    >
                        <div class="flex items-center gap-3">
                            <span
                                class="grid size-4 shrink-0 place-items-center rounded-full border"
                                :class="numberFormat === 'decimal' ? 'border-surface-inverse' : 'border-border'"
                            >
                                <span v-if="numberFormat === 'decimal'" class="size-2 rounded-full bg-surface-inverse" />
                            </span>
                            <div class="min-w-0">
                                <div class="text-sm font-semibold text-text">
