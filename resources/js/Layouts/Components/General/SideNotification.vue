                        ...
                        <div class="p-4">
                            <div class="flex items-center">
                                <div class="flex-shrink-0">
                                    <IconCircleX stroke-width="1.5" class="h-6 w-6 text-danger" aria-hidden="true" v-if="type === 'error'" />
                                    <IconGeometry stroke-width="1.5" class=" w-8 h-8 border bg-surface-sunken rounded-full p-0.5" v-if="type === 'project_create_success'"/>
                                </div>
                                ...
                                <div class="ml-4 flex flex-shrink-0">
                                    <button type="button" @click="close" class="inline-flex rounded-md bg-white text-text-subtle hover:text-text-subtle focus:outline-none focus:ring-2 focus:ring-accent-600 focus:ring-offset-2">
