<template>
    <div class="relative">
        ...
        <div :id="'tooltip' + id" role="tooltip" class="-right-12 hidden absolute -mt-40 z-100 w-fit transition duration-150 ease-in-out shadow-lg p-4 rounded text-secondary bg-primary">
