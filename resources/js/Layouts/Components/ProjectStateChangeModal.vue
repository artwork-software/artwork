    ...
    <BaseModal @closed="$emit('close')">
        <div class="space-y-6">
            ...
            <div class="flex justify-end space-x-3 mt-6">
                ...
                <button type="button" @click="requestVerification" class="inline-flex justify-center rounded-md border border-transparent shadow-sm px-4 py-2 bg-artwork-buttons-create text-base font-medium text-white hover:bg-artwork-buttons-hover focus:outline-none focus:ring-2 focus:ring-offset-2 focus:ring-accent-600 sm:text-sm">
