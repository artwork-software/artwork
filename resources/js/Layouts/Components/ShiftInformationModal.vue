    ...
    <jet-dialog-modal :show="show" @close="$emit('closeModal')">
        <template #content>
            ...
            <div class="xsLight my-4">
                Hier ist Platz für generelle Informationen. Du kannst zu den einzelnen Schichten separate Informationen
                mitgeben.
            </div>
            <textarea placeholder="Was gibt es bei den Schichten zu beachten?"
                      id="description"
            ...
            <div class="flex justify-center mt-2">
                <AddButton mode="modal" text="Speichern" @click="changeShiftDescription"/>
            </div>
        </template>
