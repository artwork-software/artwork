<template>
    <div :class="[usePage().props.auth.user.calendar_settings?.time_period_project_id === resolvedProject?.id ? 'border-[3px] border-dashed !border-special-pink' : '']">
        <div>
            <div class=" text-sm/5 font-bold text-white px-1 py-1 flex justify-between items-center rounded-t-lg"
        ...
        <div class="bg-surface-canvas rounded-b-lg" :class="[userForMultiEdit ? 'bg-accent-200/20' : '', dayString.isWeekend ? 'bg-white' : '']">
