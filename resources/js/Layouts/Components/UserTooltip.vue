<template>
    <div>
        <div :id="user.id" role="tooltip"
             class="w-96 inline-block flex flex-wrap absolute invisible z-50 py-3 px-3 text-sm font-medium text-secondary bg-primary shadow-sm opacity-0 transition-opacity duration-300 tooltip">
