    ...
    <div>
                    ...
                    <div class="mt-2 grid grid-cols-1 md:grid-cols-2 gap-4">
                        <div v-for="permission in availablePermissions" :key="permission">
                            <label class="flex items-center">
                                ...
                                <span class="ml-2 text-sm text-text-muted">{{ permission }}</span>
                            </label>
                        </div>
                    </div>
                </div>
                        ...
                        <div class="space-y-6">
                            <div class="flex items-center justify-between" v-for="token in tokens" :key="token.id">
                                ...
                                <div class="flex items-center">
                                    <div class="text-sm text-text-subtle" v-if="token.last_used_ago">
                                        Last used {{ token.last_used_ago }}
                                    </div>

                                    <button class="cursor-pointer ml-6 text-sm text-text-subtle underline"
                                    ...
                                    <button class="cursor-pointer ml-6 text-sm text-danger" @click="confirmApiTokenDeletion(token)">
                                        Delete
                                    </button>
                                </div>
                            </div>
        ...
        <jet-dialog-modal :show="displayingToken" @close="displayingToken = false">
            ...
            <template #content>
                ...
                <div class="mt-4 bg-surface-sunken px-4 py-2 rounded font-mono text-sm text-text-subtle" v-if="$page.props.jetstream.flash.token">
