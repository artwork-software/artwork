<template>
    <td class="py-4 pr-4 pl-4 text-sm font-medium whitespace-nowrap text-text sm:pl-0 dark:text-white">{{ artist.name }}</td>
    <td class="p-4 text-sm whitespace-nowrap text-text-subtle dark:text-text-subtle">{{ artist.position }}</td>
    <td class="p-4 text-sm whitespace-nowrap text-text-subtle dark:text-text-subtle">{{ artist.phone_number }}</td>
    <td class="py-4 pr-4 pl-4 text-sm whitespace-nowrap text-text-subtle sm:pr-0 dark:text-text-subtle flex items-center gap-x-2">
