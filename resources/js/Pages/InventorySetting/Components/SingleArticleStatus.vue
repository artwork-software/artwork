...
<template>
    <td class="py-4 pr-4 pl-6 text-sm font-medium whitespace-nowrap text-text dark:text-white">{{ status.name }}</td>
    <td class="p-4 text-sm whitespace-nowrap text-text-subtle dark:text-text-subtle">
    ...
    <td class="py-4 pr-4 pl-4 text-sm whitespace-nowrap text-text-subtle sm:pr-0 dark:text-text-subtle">
