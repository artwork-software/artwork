<template>
    <ToolSettingsHeader :title="$t('Module visibility')">
        ...
        <SettingsGuideBanner
            class="mt-6"
            storage-key="settings-guide.tool.module-settings"
            title="How does this area work?"
            :paragraphs="[
                'Choose which modules appear in the main navigation. Unchecking a module hides its menu entry immediately — for all users.',
                'Hiding a module does not change any permissions: all data is kept and reappears as soon as you re-enable the module here.',
            ]"
        />
