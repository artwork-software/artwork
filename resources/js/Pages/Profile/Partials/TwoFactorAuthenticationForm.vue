<template>
    <jet-action-section>
        ...
        <template #content>
            <h3 class="text-lg font-medium text-text" v-if="twoFactorEnabled">
                {{ $t('You have enabled two factor authentication.')}}
            </h3>

            <h3 class="text-lg font-medium text-text" v-else>
            ...
            <div v-if="twoFactorEnabled">
                ...
                <div v-if="recoveryCodes.length > 0">
                    ...
                    <div class="grid gap-1 max-w-xl mt-4 px-4 py-4 font-mono text-sm bg-surface-sunken rounded-lg">
