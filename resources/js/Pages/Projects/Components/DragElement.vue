...
<template>
    <div class="card glassy-shiftplan !rounded-lg">
        <div :class="[$page.props.auth.user.compact_mode ? 'h-8 flex items-center justify-between' : 'h-12']" class="drag-item w-full p-2 text-white text-xs flex items-center gap-2 relative !rounded-lg" draggable="true" @dragstart="onDragStart"  :style="{backgroundColor: backgroundColorWithOpacity(color) + '!important'}">
