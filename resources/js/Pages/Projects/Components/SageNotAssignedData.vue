<template>
    <div class="my-3 ml-6">
        <div v-if="this.$canAny(['can view project sage data'])">
            <div class="flex items-center gap-x-1 cursor-pointer"
                ...
                <IconChevronUp v-if="this.projectGroupOpened" class="h-6 w-6 text-text my-auto" />
                <IconChevronDown v-else class="h-6 w-6 text-text my-auto" />
            </div>
        ...
        <div v-if="this.$canAny(['can view global sage data'])">
            <div class="flex items-center gap-x-1 cursor-pointer"
                 @click="this.globalGroupOpened = !this.globalGroupOpened">
                <h4 class="font-bold">{{ $t('Global Sage data') }}</h4>
                <IconChevronUp v-if="this.globalGroupOpened" class="h-6 w-6 text-text my-auto" />
                <IconChevronDown v-else class="h-6 w-6 text-text my-auto" />
            </div>
...
export default {
    ...
    components: {SageDataDragElement, IconChevronDown, IconChevronUp},
