                                        ...
                                        <div>
                                            <div>
                                                ...
                                                <div class="relative mt-2 rounded-md shadow-sm">
                                                    <input v-model="userSearch" ref="searchFieldUserSearch" type="text" name="account-number" id="account-number" class="block w-full rounded-lg border border-white/10 py-1.5 pl-3 pr-10 text-white ring-0  placeholder:text-white/70 sm:text-sm sm:leading-6" />
