...
export default {
    name: "TextField",
    components: {Link, BaseInput, InfoButtonComponent, TextInputComponent},
    props: [
        'data',
        'projectId',
        'inSidebar',
...
<template>
    <div class="my-2 flex items-start gap-x-4">
        <div>
            ...
            <div v-else>
                <a :href="text" target="_blank" class="text-blue-600 hover:underline" v-if="text && text.length > 0">{{ text }}</a>
            </div>
        </div>
