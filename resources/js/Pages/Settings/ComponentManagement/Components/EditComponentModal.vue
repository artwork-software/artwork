...
export default {
    ...
    data(){
        return {
            open: true,
            textData: this.componentToEdit ? JSON.parse(JSON.stringify(this.componentToEdit.data)) : {},
            componentName: this.componentToEdit ? this.componentToEdit.name : '',
            helpTexts: {
                name: ''
            }
        }
    ...
    methods: {
        ...
        update() {
            ...
            this.$inertia.patch(route('component.update', {component: this.componentToEdit.id}),{
