                    ...
                    >
                        <div class="min-w-0">
                            ...
                            <div class="mt-1 flex flex-wrap items-center gap-2 text-xs text-text-subtle">
                                <span class="inline-flex items-center gap-1">
                                  <span class="font-semibold text-text-muted">{{ groupSummary(g).total }}</span>
                                  {{ $t('presets') }}
                                </span>
                        ...
                        <div class="flex shrink-0 items-center gap-2">
                            <button
                                ...
                                :aria-label="$t('Edit')"
                            >
                                <PropertyIcon name="IconEdit" class="text-text-muted"/>
                            </button>
                            ...
                            <button
                                ...
                                :aria-label="$t('Delete')"
                            >
                                <PropertyIcon name="IconTrash" class="text-danger"/>
                            </button>
                        </div>
                    </li>
                </TransitionGroup>
