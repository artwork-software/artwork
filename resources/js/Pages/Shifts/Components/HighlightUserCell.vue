...
<template>
    <div class="card glassy">
        <div @click="$emit('highlightShiftsOfUser', item.id, type)" class="w-full p-2 text-white text-xs rounded-3xl flex items-center gap-2 "  :style="{backgroundColor: backgroundColorWithOpacity(color), divStyle}">
