<template>
    <div :class="classes">
        ...
        <div v-for="individual_time in user.individual_times" v-if="!checkIfUserHasVacationOnDay(user, day.without_format)">
        ...
        <span v-if="user.shift_comments[day.without_format] && !checkIfUserHasVacationOnDay(user, day.without_format)">
            {{ user.shift_comments[day.without_format][0].comment }}
        </span>
        <span v-if="user.availabilitie">
