<template>
    <div>
        <div>
            <div class="text-secondaryHover xsWhiteBold px-2 py-1 rounded-lg flex items-stretch gap-x-2"
                ...
                <div class="py-1 max-w-40 w-40" :style="{borderColor: event.eventType.hex_code}">
