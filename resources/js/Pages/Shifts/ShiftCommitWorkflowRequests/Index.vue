<template>
    <AppLayout title="Antragsübersicht">
        <div class="max-w-4xl mx-auto py-8 font-lexend">
            <h1 class="text-3xl font-semibold text-gray-900 mb-8">Anträge</h1>
...
const approveRequest = (requestId) => {
    ...
    router.patch(route('shifts.commit-requests.approve', requestId), {
    })
};

const declineRequest = (requestId) => {
    // Logic to decline the request
    router.patch(route('shifts.commit-requests.decline', requestId), {
    })
};
</script>
