<template>
    <div class="flex items-center px-2 py-1.5 gap-x-1 justify-between group cursor-default">
        ...
        <component :is="IconTrash" @click="showConfirmDeleteModal = true" stroke-width="1.5" class="invisible min-h-5 min-w-5 h-5 w-5 hover:text-danger group-hover:visible transition-colors duration-300 ease-in-out cursor-pointer"/>
    </div>
