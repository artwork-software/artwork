    ...
    data() {
        return {
            ...
            tabs: [
                ...
                {id: 5, name: 'Work Times', href: route('user.edit.worktimes', {user: this.user_to_edit.id}), current: route().current('user.edit.worktimes'), has_permission: this.$can('can manage workers') || this.hasAdminRole(), icon: 'IconCalendarTime'},
            ],
