    ...
    data() {
        return {
            ...
            tabs: [
                ...
                {name: 'Overtime', href: route('user.edit.overtime', {user: this.user_to_edit.id}), current: route().current('user.edit.overtime'), permission: this.$can('can manage workers') || this.hasAdminRole(), icon: 'IconClockExclamation'},
            ],
