    ...
    <ArtworkBaseModal
        ...
        <form>
            ...
            <div class="flex items-center justify-between mt-5">
                <ArtworkBaseModalButton type="submit" class="mt-4" variant="danger" @click="$emit('close')">
                    {{ $t('Cancel') }}
                </ArtworkBaseModalButton>

                <ArtworkBaseModalButton type="button" variant="secondary" class="mt-4" @click="declineRequest">
                    {{ $t('Decline') }}
                </ArtworkBaseModalButton>
            </div>
        </form>
