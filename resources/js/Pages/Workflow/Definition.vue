        ...
        <div class="py-12">
            <div class="max-w-7xl mx-auto sm:px-6 lg:px-8">
                <div class="bg-white overflow-hidden shadow-xl sm:rounded-lg p-6">
                    ...
                    <div class="mb-8">
                        <h3 class="text-lg font-medium text-text mb-4">{{ $t('Workflow Definition Details') }}</h3>
                        <div class="grid grid-cols-1 md:grid-cols-2 gap-4">
                            <div>
                                <p class="text-sm font-medium text-text-subtle">{{ $t('Name') }}</p>
                                <p class="mt-1 text-sm text-text">{{ definition.name }}</p>
                            </div>
                            <div>
                                <p class="text-sm font-medium text-text-subtle">{{ $t('Type') }}</p>
                                <p class="mt-1 text-sm text-text">{{ definition.type }}</p>
                            </div>
                            <div>
                            ...
                            <div>
                                ...
                                <p class="mt-1 text-sm text-text">{{ new Date(definition.created_at).toLocaleString() }}</p>
                            </div>
                        </div>
                    </div>
                    ...
                    <div>
                        ...
                        <div class="border border-border-subtle rounded-lg p-4 bg-surface-sunken">
                            <pre class="text-sm text-text overflow-auto">{{ JSON.stringify(definition.current_config.config, null, 2) }}</pre>
                        </div>
                    </div>
                </div>
            </div>
