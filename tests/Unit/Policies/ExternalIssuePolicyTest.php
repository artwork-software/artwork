...
use App\Policies\ExternalIssuePolicy;
use Artwork\Modules\ExternalIssue\Models\ExternalIssue;
use Artwork\Modules\User\Models\User;
use PHPUnit\Framework\Attributes\Test;
use Tests\TestCase;

final class ExternalIssuePolicyTest extends TestCase
{
    private ExternalIssuePolicy $policy;

    protected function setUp(): void
    {
        parent::setUp();
        $this->policy = app(ExternalIssuePolicy::class);
    }

    private function existingModel(): ExternalIssue
    {
        $model = new ExternalIssue();
        $model->exists = true;
    ...
    {
        $this->assertFalse($this->policy->view(User::factory()->create(), new ExternalIssue()));
    }
